                ...
                <TabContext value={value}>
                    <Box  >
                        <TabList onChange={handleChange} TabIndicatorProps={{ style: { backgroundColor: "#abfe2c ", color: "#abfe2c " } }} aria-label="lab API tabs example">
                            <CustomTab label="Mint Student Academic Record" value="Mint Student Academic Record" />
                            <CustomTab label="Mint Course Record" value="Mint Course Record" />
                        </TabList>
                    </Box>
                    <TabPanel value="Mint Student Academic Record">Item One</TabPanel>
